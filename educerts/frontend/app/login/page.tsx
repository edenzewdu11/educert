        ...
        <div className="min-h-screen grid lg:grid-cols-2">
            ...
            <div className="hidden lg:flex bg-gradient-to-br from-sky-50 via-sky-100 to-sky-50 border-r border-slate-200 flex-col p-12 justify-between relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <h2 className="text-6xl font-bold leading-tight mb-6 text-slate-900">
                        Secure, Verifiable, <br /> <span className="gradient-text">Professional.</span>
                    </h2>
                ...
                <div className="w-full max-w-md">
                    ...
                    >
                        ...
                        <div className="text-center lg:text-left mb-8">
                            <h3 className="text-4xl font-bold text-slate-900 mb-2">{isLogin ? "Sign In" : "Get Started"}</h3>
                            <p className="text-slate-600 font-medium text-lg">{isLogin ? "Access your digital certificates." : "Create an account to start issuing."}</p>
                        </div>
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    <div className="space-y-2">
                                        <label className="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1">Name / Username</label>
