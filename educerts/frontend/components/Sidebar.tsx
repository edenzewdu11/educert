  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={`fixed left-0 top-0 z-50 h-screen bg-white border-r border-slate-200 flex flex-col shadow-sm lg:translate-x-0 lg:static lg:z-auto ${mobileOpen ? "w-64" : "-translate-x-full lg:translate-x-0 lg:w-64"}`}
      >
